    ...
    <div className={styles.container}>
      <section>
        <div className={styles.title}>
          ABOUT ME
          <div className={`${OoohBaby.className} ${styles.name}`}>
            Jiwoo Choi
          </div>
        </div>
      ...
      <section className={styles.bottom}>
        ...
        <div className={`${notoSans.className} ${styles.desc}`}>
          <b>함께할 때 더 빛나는 개발자</b>,{" "}
          <b style={{ color: vars.color.yellow300 }}>최지우</b>
          입니다.{"\n"}
          사용자와 직접 소통하는 <b>프론트엔드</b>에 매력을 느껴{"\n"}
          여러 <b>교육, 프로젝트, 인턴을 진행</b>하며 개발경험을 쌓았습니다.
          {"\n"}
          <b>좋은 협업</b>에 대해 고민하고 <b>성능, 유지 보수성에 집중</b>
          하며 개발하고 있습니다.
        </div>
        <div className={styles.educar}>
          ...
          <div className={styles.listTitle}>
            Career
            <div className={styles.list}>
              <p className={`${styles.wordBreak}`}>2022.07 - 2022.12{"\n"}</p>
              <p className={`${notoSans.className} ${styles.wordBreak}`}>
                (주)민트기술 인턴{"\n"}- 프론트엔드 개발자
              </p>
            </div>
        ...
        <Link href="skills" className={styles.next}>
          Next
          <div className={styles.nextTitle}>SKILLS &#8640;</div>
          {/* <div className={styles.nextTitle}>&#8640;</div> */}
        </Link>
        {/* <div className={styles.nextTitle}>SKILLS{"\n"}</div> */}
      </section>
    </div>
  );
}
